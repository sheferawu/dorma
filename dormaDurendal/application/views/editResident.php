...
<html>
	...
	<body>
		<form action="index.php?c=resident&m=updateData" method="POST" name="residentForm"  onsubmit="return(validateForm(this))">
			...
			<div class="resident_info">
				<table class="addResi">
						...
						<td>
							...
							<select name="Month"  onchange="getMonth(this.options[this.selectedIndex].value,'Day','Year')">
								<?php 
									...
									?>
									<?php echo 
										"<option value=\"1\" $bool[0]>January</option>
										<option value=\"2\" $bool[1] >February</option>
										<option value=\"3\" $bool[2]>March</option>
										<option value=\"4\" $bool[3]>April</option>
										<option value=\"5\" $bool[4]>May</option>
										<option value=\"6\" $bool[5]>June</option>
										<option value=\"7\" $bool[6]>July</option>
										<option value=\"8\" $bool[7]>August</option>
										<option value=\"9\" $bool[8]>September</option>
										<option value=\"10\" $bool[9]>October</option>
										<option value=\"11\" $bool[10]>November</option>
										<option value=\"12\" $bool[11]>December</option>";
									?>
							</select>
					...
					<tr>
						<td>Talent(s):</td>
						<td><input type="text" name="Talents0" size="35"  value='<?php if(isset($resident["TalentName"])) echo $resident["TalentName"];?>'><div id="addTalent" style="display:inline;"></div></td>
		...
		<div class="appliance_info" id="appliance_info" >
						...
						<table class = "app" id = "app">
							...
							<tr>
								...
								<td>
									...
									?>
									<?php echo "<tr> <td>"; ?>
									<select name="ApplianceName" id="ApplianceName0" > 
			...
			<h3 class="violation_title" onclick="dropDown('violation_info')">Violation</h3>
			<div class="violation_info">
				<table class="violation_table">
					...
					<tr>
						<td>
							<select name="dovMonth" id="dovMonth" onchange="getMonth(this.options[this.selectedIndex].value,'dovDay','dovYear')">
							<?php $bool="";
								$dovDate = $resident["DateOfViolation"];
								$dovArray = explode("/", $dovDate);	
								...
								for($i=0;$i<12;$i++){
									...
									if(trim($dovArray[0]) == "1") $bool[0]="selected=\"selected\"" ;
									else if(trim($dovArray[0]) == "2") $bool[1]="selected=\"selected\"" ;
									else if(trim($dovArray[0]) == "3") $bool[2]="selected=\"selected\"" ;
									else if(trim($dovArray[0]) ==  "4") $bool[3]="selected=\"selected\"" ;
									else if(trim($dovArray[0]) == "5") $bool[4]="selected=\"selected\"" ;
									else if(trim($dovArray[0]) == "6") $bool[5]="selected=\"selected\"" ;
									else if(trim($dovArray[0]) == "7") $bool[6]="selected=\"selected\"" ;
									else if(trim($dovArray[0]) == "8") $bool[7]="selected=\"selected\"" ;
									else if(trim($dovArray[0]) == "9") $bool[8]="selected=\"selected\"" ;
									else if(trim($dovArray[0]) == "10") $bool[9]="selected=\"selected\"" ;
									else if(trim($dovArray[0]) == "11") $bool[10]="selected=\"selected\"" ;
									else if(trim($dovArray[0]) == "12") $bool[11]="selected=\"selected\"" ;
							...
							<div style="display:inline;" id = "dovDay">
								<select name="dovDay" >
									<?php 
									echo "<option value=\"$dovArray[1]\">$dovArray[1]</option>";					
								?>
								</select>
							</div>
							<div style="display:inline;" id = "dovYear">
								<select name="dovYear">
									<?php 
									echo "<option value=\"$dovArray[2]\">$dovArray[2]</option>";					
								?>
								</select>
							</div>
							</td>
						...
						<td><input type="text" id="nature" name="nature" size="16" value='<?php if(isset($resident["Nature"])) echo $resident["Nature"];?>'/> </td>
						<td><input type="text" id="actionTaken" name="actionTaken" size="16" value='<?php if(isset($resident["ActionTaken"])) echo $resident["ActionTaken"];?>'/> </td>
						<td>
							<select name="vMonth" id="vMonth" onchange="getMonth(this.options[this.selectedIndex].value,'vDay','vYear')">
							<?php $bool="";
								$vDate = $resident["Date"];
								$vArray = explode("/", $vDate);	
								...
								for($i=0;$i<12;$i++){
									...
									if(trim($vArray[0]) == "1") $bool[0]="selected=\"selected\"" ;
									else if(trim($vArray[0]) == "2") $bool[1]="selected=\"selected\"" ;
									else if(trim($vArray[0]) == "3") $bool[2]="selected=\"selected\"" ;
									else if(trim($vArray[0]) ==  "4") $bool[3]="selected=\"selected\"" ;
									else if(trim($vArray[0]) == "5") $bool[4]="selected=\"selected\"" ;
									else if(trim($vvArray[0]) == "6") $bool[5]="selected=\"selected\"" ;
									else if(trim($vArray[0]) == "7") $bool[6]="selected=\"selected\"" ;
									else if(trim($vArray[0]) == "8") $bool[7]="selected=\"selected\"" ;
									else if(trim($vArray[0]) == "9") $bool[8]="selected=\"selected\"" ;
									else if(trim($vArray[0]) == "10") $bool[9]="selected=\"selected\"" ;
									else if(trim($vArray[0]) == "11") $bool[10]="selected=\"selected\"" ;
									else if(trim($vArray[0]) == "12") $bool[11]="selected=\"selected\"" ;
							...
							<div style="display:inline;" id = "vDay">
								<select name="vDay" >
									<?php 
									echo "<option value=\"$vArray[1]\">$vArray[1]</option>";					
								?>
								</select>
							</div>
							<div style="display:inline;" id = "vYear">
								<select name="vYear">
									<?php 
									echo "<option value=\"$vArray[2]\">$vArray[2]</option>";					
								?>
								</select>
							</div>
						</td>
