...
if (!isset($_SESSION['tally'])){
	...
	echo "<h3 class=\"balance_title\" onclick=\"dropDown('balanceTable')\">Balance</h3>
		<div class=\"balanceTable\" id=\"residentBalance\">".$table."</div><br/>";
	...
	echo "<h3 class=\"violation_title\" onclick=\"dropDown2('violation_info')\">Violation</h3>
		<div class=\"violation_info\" id=\"violation\">".$violation."</div><br/>";
