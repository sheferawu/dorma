<html>
	...
	<body>
		...
		<form action="index.php?c=resident&m=getData" method="POST" name="residentForm"  onsubmit="return(validateForm(this))">
			<h3 class="required_title" onclick="dropDown('required_info')">Required Information</h3>
			<div class="required_info">
				<table class="req_table">
					<tr>
						<td><a name="top">Last Name:</a></td>					
					...
					<tr>
						...
						<td><select name="Batch" onchange="setBatch(this.options[this.selectedIndex].value)">
							<?php 
							  $limit= strftime("%Y")+1;
							for($i = $limit;$i>=1950;$i--) {echo "<option value=\"$i\">$i</option>";}
								?>
							</select>
		...
		<div class="appliance_info" id="appliance_info" >
			...
			<div class="reservation_info">
				<table class="reservation_table">
					...
					<tr>					
						<td><input type="text" name="OrNum" id="OrNum" size="16" onChange="copyValue()"/></td>
						<td>
							<select name="MonthR" id="MonthR" onchange="getMonth(this.options[this.selectedIndex].value,'DayR','YearR')" onBlur="copyValue()">
							...
							<div style="display:inline;" >
								<select name="DayR" id = "DayR" onChange="copyValue()">
									<option value="">D</option>
								</select>
							</div>
							<div style="display:inline;" >
								<select name="YearR" id = "YearR" onChange="copyValue()">
									<option value="">Y</option>
									<option value=""></option>
								</select>
							</div>
				...
				<table class="key_table">
					...
					<tr>			
						...
						<td><select name="MonthRec" id="MonthRec" onchange="getMonth(this.options[this.selectedIndex].value,'DayRec','YearRec')">
							...
							<div style="display:inline;" >
								<select name="DayRec" id = "DayRec" >
									<option value="">D</option>
								</select>
							</div>
							<div style="display:inline;" >
								<select name="YearRec" id = "YearRec">
									<option value="">Y</option>
									<option value=""></option>
								</select>
							</div></td>
